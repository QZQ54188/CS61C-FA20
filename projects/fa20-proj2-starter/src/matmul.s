...
matmul:
    ...
    # Error checks
    li t0, 1
    blt a1, t0, error_dimensionM0       # if length < 1, go to exit
    blt a2, t0, error_dimensionM0
    blt a4, t0, error_dimensionM1
    blt a5, t0, error_dimensionM1
    bne a2, a4, error_dimensionMatch
